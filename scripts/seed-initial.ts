...
const BRANDS = [
  { slug: "nordictrack", name: "NordicTrack", country: "USA", description: "NordicTrack is a leading brand of home fitness equipment owned by iFIT Health & Fitness, known for treadmills, ellipticals, and exercise bikes with interactive training technology.", website: "https://www.nordictrack.com" },
  { slug: "weider", name: "Weider", country: "USA", description: "Weider is a fitness equipment brand owned by Icon Health & Fitness, producing home gyms, weight benches, and strength training equipment since 1936.", website: "https://www.weider.com" },
  { slug: "proform", name: "ProForm", country: "USA", description: "ProForm is a fitness equipment brand under iFIT Health & Fitness offering treadmills, exercise bikes, and ellipticals with interactive streaming workouts.", website: "https://www.proform.com" },
  { slug: "bowflex", name: "Bowflex", country: "USA", description: "Bowflex is a Nautilus brand offering home gyms, resistance machines, dumbbells, and cardio equipment for home fitness.", website: "https://www.bowflex.com" },
  { slug: "lifefitness", name: "LifeFitness", country: "USA", description: "Life Fitness is a global leader in commercial-grade fitness equipment used in gyms, hotels, and corporate facilities worldwide.", website: "https://www.lifefitness.com" },
  { slug: "precor", name: "Precor", country: "USA", description: "Precor manufactures premium commercial and home fitness equipment including ellipticals, treadmills, and strength training systems.", website: "https://www.precor.com" },
  { slug: "schwinn", name: "Schwinn", country: "USA", description: "Schwinn produces fitness equipment including upright bikes, recumbent bikes, and indoor cycling bikes for home use.", website: "https://www.schwinnfitness.com" },
  { slug: "body-solid", name: "Body-Solid", country: "USA", description: "Body-Solid manufactures strength training equipment including home gyms, cable machines, and free weight equipment.", website: "https://www.bodysolid.com" },
  { slug: "marcy", name: "Marcy", country: "USA", description: "Marcy produces affordable home gym equipment including multi-station home gyms, weight benches, and cardio machines.", website: "https://www.marcypro.com" },
  { slug: "sole-fitness", name: "Sole Fitness", country: "USA", description: "Sole Fitness produces high-quality treadmills, ellipticals, and exercise bikes for home use, known for durability and value.", website: "https://www.soletreadmills.com" },
  { slug: "horizon-fitness", name: "Horizon Fitness", country: "USA", description: "Horizon Fitness is a Johnson Health Tech brand offering treadmills, ellipticals, and exercise bikes for home use.", website: "https://www.horizonfitness.com" },
  { slug: "cybex", name: "Cybex", country: "USA", description: "Cybex International manufactures premium commercial fitness equipment including treadmills, ellipticals, and strength machines.", website: "https://www.cybexintl.com" },
  { slug: "nautilus", name: "Nautilus", country: "USA", description: "Nautilus produces home fitness equipment including treadmills, ellipticals, and the classic Nautilus strength training systems.", website: "https://www.nautilus.com" },
  { slug: "gold-gym", name: "Gold's Gym", country: "USA", description: "Gold's Gym produces consumer fitness equipment including treadmills, exercise bikes, and home gyms under the iconic Gold's Gym brand.", website: "https://www.goldsgym.com" },
];
